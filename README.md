...
2. Таблица пользователей с возможностью добавлять, удалять;
3. Таблица проверенных заданий с возможностью архивации.

Личный кабинет (Директор):
1. Логин / Почта / Статус /  ФИО / Кнопки "Сменить пароль" / "Выйти";
...
1. Таблица пользователей ( id / login / fio / password / email / access )
